...
import { syncNodes, nodeStats, buildWorkflow } from "../api/ai";
        ...
        <DescribeModal
          ...
          initial={{
            ...
            input_node_ids: describeTarget.template.input_node_ids
              || [describeTarget.template.prompt_node_id, describeTarget.template.image_node_id]
        ...
        <DescribeModal
          ...
          initial={{
            ...
            input_node_ids: template?.input_node_ids
              || [template?.prompt_node_id, template?.image_node_id].filter((x): x is string => !!x),
